...
* [`input {}`](./input)
* [`output "eDP-1" {}`](./outputs)
* [`binds {}`](./key-bindings)
* [`switch-events {}`](./switch-events)
* [`layout {}`](./layout)
* [top-level options](./miscellaneous)
* [`window-rule {}`](./window-Rules)
...
A notable exception is [`binds {}`](./key-bindings): they do not get filled with defaults, so make sure you do not erase this section.
